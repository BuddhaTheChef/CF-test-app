...
/bin/sh -c "${_JAVACMD} --add-opens=java.rmi/sun.rmi.transport=ALL-UNNAMED --add-opens=java.base/java.nio=ALL-UNNAMED --add-opens=java.base/java.lang=ALL-UNNAMED --add-opens=java.base/sun.util.cldr=ALL-UNNAMED  --add-opens=java.base/sun.util.locale.provider=ALL-UNNAMED --add-opens=java.base/java.net=ALL-UNNAMED --add-opens=java.base/java.io=ALL-UNNAMED -Dcom.sun.media.jai.disableMediaLib=true -Djava.awt.headless=true -Dcoldfusion.repl.print=$PRINT_REPL_VARS_AUTO -Dorg.owasp.esapi.resources=$CFUSION_HOME/lib -Dcoldfusion.classPath=$CFUSION_HOME/lib/updates:$CFUSION_HOME/lib:$CFUSION_HOME/lib/axis2 -Dcoldfusion.libPath=$CFUSION_HOME/lib -cp $CFUSION_HOME/lib/updates/*:$CFUSION_HOME/lib/*:$CFUSION_HOME/lib/itext/*:$WEBINF/lib/*:$CFUSION_HOME/runtime/lib/*:$CFUSION_HOME/runtime/bin/*:$CFUSION_HOME/bin:$J2EEJAR coldfusion.tools.CLIInvoker CLI $*"
